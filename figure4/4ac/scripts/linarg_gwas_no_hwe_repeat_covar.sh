...
bash /mnt/project/amber/scripts/profile.sh linarg_gwas_no_hwe_repeat_covar_${dataset}_chr1-22_${node}.csv \
    kodama assoc \
        $linarg \
        phenotypes.tsv \
        ...
        --chrom ${chromosomes[@]}  \
        --out linarg_gwas_no_hwe_repeat_covar_${dataset}_chr1-22_${node} \
        --no-hwe \
        --repeat-covar \
